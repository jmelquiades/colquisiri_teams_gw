...
- Después de cada respuesta el bot guarda hasta las últimas 5 consultas y te muestra botones para repetirlas; también puedes escribir `historial` para ver ese listado cuando lo necesites.
